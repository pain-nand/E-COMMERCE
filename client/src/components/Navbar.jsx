      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between flex-wrap items-center">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            <Link
              to={"/"}
              className="text-gray-300 hover:emerald-400 transition duration-300 ease-in-out"
            >
              Home
            </Link>
            {user && (
              <Link
                to={"/cart"}
                className="relative group text-gray-300 hover:emerald-400 transition duration-300 ease-in-out"
              >
                <ShoppingCart
